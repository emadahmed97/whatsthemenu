...
var _dompurify = __webpack_require__(10);
...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    (0, _bling.$)('.heart-count').textContent = res.data.hearts.length + res.data.heartsitem.length;
    if (isHearted) {
...
function makeMap(mapDiv) {
  ...
  autocomplete.addListener('place_changed', function () {
    ...
    loadPlaces(map, place.geometry.location.lat(), map, place.geometry.location.lng());
  });
}
...
var _frontend = __webpack_require__(13);
...
var modal = (0, _bling.$$)('form.openModal');
modal.on('submit', _frontend2.default);
